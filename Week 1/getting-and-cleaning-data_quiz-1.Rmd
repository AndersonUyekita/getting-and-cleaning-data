...
* &#x1F4C6; Week 1
    * &#x1F6A6; Start: 2022/05/20
    * &#x1F3C1; Finish: 2022/05/20
* `r if(!knitr::is_html_output()) {"&#x1F30E; Rpubs: [Interactive Document](https://rpubs.com/AndersonUyekita/getting-and-cleaning-data_quiz-1)"}else{":octocat: Github Repository: [Static Document](https://github.com/AndersonUyekita/getting-and-cleaning-data/blob/main/Week%201/getting-and-cleaning-data_quiz-1.md)"}`
...
**NOTE:** The time differences will lead to a wrong answer. According to the "data.table video", the best solution would be that use DT due to:
